    ...
    return (
      <>
        <SplitTextWrapper ref={splitTextRef} variables={{ type: 'lines' }} data-testid="wrapper">
          ...
          <br /> illo molestias, <strong data-testid="code">quia sapiente</strong> modi quo
      ...
      <>
        <SplitTextWrapper
          ...
          dangerouslySetInnerHTML={{
            ...
            __html:
              'Lorem ipsum dolor sit <i>amet consectetur</i> <br /> adipisicing elit. <b>Tenetur perspiciatis</b> eius ea, ratione,<br /> illo molestias, <strong>quia sapiente</strong> modi quo<br /> molestiae temporibus.',
          }}
        />
        <button
          onClick={onPlay}
